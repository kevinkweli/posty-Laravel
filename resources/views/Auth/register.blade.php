        ...
        <div class="w-8/12 bg-white p-6 rounded-lg">
            <form action="{{route('register')}}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <!-- You need to recall the old session data on "Value" incase user forget to insert one of the input data-->
                    @error('name')
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Repeat the password" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('password_confirmation') border-red-500 @enderror" value="">
